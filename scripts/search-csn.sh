...
echo 'ldap1 admin'
searchcsn -H ldap://ldap1."$LDAP_DOMAIN" -D "$ADMIN_DN" -w "$ADMIN_PASSWORD" -b "$LDAP_DN"
...
echo 'replica admin'
searchcsn -H ldap://replica1."$LDAP_DOMAIN" -D "$ADMIN_DN" -w "$ADMIN_PASSWORD" -b "$LDAP_DN"
...
echo 'ldap1 config'
searchcsn -H ldap://ldap1."$LDAP_DOMAIN" -D "$CONFIG_DN" -w "$CONFIG_PASSWORD" -b "$BASE"
